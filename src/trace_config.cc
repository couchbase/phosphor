...
trace_buffer_factory TraceConfig::BufferFactoryContainer::modeToFactory(
        BufferMode mode) {
    switch (mode) {
...
TraceConfig::BufferFactoryContainer::BufferFactoryContainer(BufferMode m)
    : mode(m), factory(modeToFactory(m)) {
}

TraceConfig::BufferFactoryContainer::BufferFactoryContainer(
        trace_buffer_factory f)
    : mode(BufferMode::custom), factory(f) {
}
